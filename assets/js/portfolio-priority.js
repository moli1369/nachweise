(() => {
  const boot = () => {
    ...
    style.textContent = `
      ...
      .voip-line{fill:none;stroke:rgba(121,237,188,.22);stroke-width:2}
      .voip-flow{fill:none;stroke:#79edbc;stroke-width:2.4;stroke-dasharray:4 12;animation:voipFlow 2.3s linear infinite}
      .voip-node rect,.voip-node circle{fill:#071723;stroke:rgba(121,237,188,.25);stroke-width:1.4}
      .voip-node.main rect{stroke:rgba(66,199,255,.45);fill:#081c2b}
      ...
      <div class="voip-shell">
        ...
        <div class="voip-map">
          <svg class="voip-svg" viewBox="0 0 900 250" aria-hidden="true">
            <path class="voip-line" d="M160 125 H335 M335 125 H470 M470 125 H620 M620 125 H760"/>
            <path class="voip-flow" d="M160 125 H335 M335 125 H470 M470 125 H620 M620 125 H760"/>
            ...
            <g class="voip-node main"><circle cx="400" cy="125" r="48"/><text x="400" y="120">ISABELL</text><text x="400" y="136" class="sub">VIRTUAL PBX</text></g>
    ...
    keyframes.textContent='@keyframes voipPacket{0%{transform:translateX(0)}28%{transform:translateX(175px)}50%{transform:translateX(310px)}72%{transform:translateX(470px)}100%{transform:translateX(580px)}}';
